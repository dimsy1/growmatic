...
const DEVICE_ID = "grow_matic_2";
const API_TOKEN = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiJ0b2tlbl9kYXNoYm9hcmRfMiIsInN2ciI6ImFwLXNvdXRoZWFzdC5hd3MudGhpbmdlci5pbyIsInVzciI6InN1YmVrdGliaW1vd2ljYWtzb25vIn0.DIY9iH05Q8GeNEHrmLB5c3i-Yyd5iLTH78KoM32fiyE";
...
function handleSensorData(temp, hum) {
  ...
  if (currentStore.timeLabels.length > 0) {
    const lastLabel = currentStore.timeLabels[currentStore.timeLabels.length - 1];
...
async function fetchWeatherByLocation(lat, lon) {
  try {
    ...
    document.getElementById('weather-location').innerText = 'Gagal memuat data cuaca';
  }
}
